#include<iostream>				// untuk fungsi standard input output yaitu cin dan cout
#include<conio.h>				//
#include<direct.h> 
#include <windows.h>
#include <time.h>
...
/* gotoxy()
 * Function = untuk memudahkan dalam memindahkan posisi kursor dalam x baris dan y kolom
 *
 */
...
/* updateScore()
 * Function = untuk mengupdate score setiap kali pemain memindahkan sebuah balok
 *
 */
void updateScore(){
	SetConsoleTextAttribute(console, FOREGROUND_INTENSITY | FOREGROUND_RED | FOREGROUND_GREEN);
	gotoxy(15, 18);cout<<"Point: "<<tries<<endl;
	tries += 10;
}

/* instructions()
 * Function = untuk mencetak instruksi cara memainkan game
 *
 */
void instructions(){
...
/* drawTower
 * Function = untuk mencetak animasi text berbentuk tower dan wadah pada permulaan game
 *
 */
...
void play(){
	...
	do{
		...
		if (GetAsyncKeyState(VK_ESCAPE)) {
			gotoxy(10, 7); cout << "|\tYou pressed esc!\t|";
			Sleep(1000);
			gotoxy(10, 8); cout << "|\tQuiting game! :)\t|";
			Sleep(1000);
			gotoxy(10, 10); cout << "\t>> Bye ~~~~~~~";
			Sleep(1000);
			exit(0);
		}
		cout<<"============================================================"<<endl;
